...
def _get_llm(model_name: str = "llama-3.1-8b-instant") -> Runnable:
...
def build_summary_agent():
    ...
    user_prompt = (
        ...
        "Product: {product}\n\n"
        "Transcript:\n{transcript}\n\n"
        "Determine what type of product of is being reviewed and then accordingly your job is to extract a clear list of Pros and Cons with appropiate details from the transcript."
    )
